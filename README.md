...
| --- | --- | --- | --- |
| langgenius/ollama | Ollama | Ollama | [langgenius_ollama_0.0.6.difypkg](/downloads/model/langgenius_ollama_0.0.6.difypkg) |
| langgenius/openai | OpenAI | OpenAI 提供的模型，例如 GPT-3.5-Turbo 和 GPT-4。 | [langgenius_openai_0.0.22.difypkg](/downloads/model/langgenius_openai_0.0.22.difypkg) |
...
| langgenius/tongyi | 通义千问 | 通义千问 | [langgenius_tongyi_0.0.21.difypkg](/downloads/model/langgenius_tongyi_0.0.21.difypkg) |
| langgenius/siliconflow | 硅基流动 | 硅基流动提供对各种模型（LLM、文本嵌入、重排序、STT、TTS）的访问，可通过模型名称、API密钥和其他参数进行配置。 | [langgenius_siliconflow_0.0.12.difypkg](/downloads/model/langgenius_siliconflow_0.0.12.difypkg) |
| langgenius/openai\_api\_compatible | OpenAI-API-compatible | 兼容 OpenAI API 的模型供应商，例如 LM Studio 。 | [langgenius_openai\_api\_compatible_0.0.14.difypkg](/downloads/model/langgenius_openai\_api\_compatible_0.0.14.difypkg) |
| langgenius/gemini | Gemini | 谷歌提供的 Gemini 模型. | [langgenius_gemini_0.1.5.difypkg](/downloads/model/langgenius_gemini_0.1.5.difypkg) |
| langgenius/volcengine\_maas | 火山方舟 | 火山方舟提供的模型，例如 Doubao-pro-4k、Doubao-pro-32k 和 Doubao-pro-128k。 | [langgenius_volcengine\_maas_0.0.12.difypkg](/downloads/model/langgenius_volcengine\_maas_0.0.12.difypkg) |
...
| langgenius/openrouter | OpenRouter | OpenRouter 是一个强大的平台，提供对多种语言模型的访问，包括商业和开源选项。 | [langgenius_openrouter_0.0.8.difypkg](/downloads/model/langgenius_openrouter_0.0.8.difypkg) |
...
| langgenius/bedrock | Amazon Bedrock | The models of Amazon Bedrock | [langgenius_bedrock_0.0.15.difypkg](/downloads/model/langgenius_bedrock_0.0.15.difypkg) |
...
| langgenius/vertex\_ai | Vertex AI \| Google Cloud Platform | Vertex AI in Google Cloud Platform. | [langgenius_vertex\_ai_0.0.11.difypkg](/downloads/model/langgenius_vertex\_ai_0.0.11.difypkg) |
...
| langgenius/gitee\_ai | Gitee AI | 快速体验大模型，领先探索 AI 开源世界 | [langgenius_gitee\_ai_0.1.0.difypkg](/downloads/model/langgenius_gitee\_ai_0.1.0.difypkg) |
...
| junjiem/mcp\_sse | MCP SSE / StreamableHTTP | 通过 HTTP with SSE 或 Streamable HTTP 传输方式使用 MCP 协议来发现和调用工具。 | [junjiem_mcp\_sse_0.1.4.difypkg](/downloads/tool/junjiem_mcp\_sse_0.1.4.difypkg) |
...
| bowenliang123/md\_exporter | Markdown 转换器 | 导出 Markdown 为 DOCX, PPTX, XLSX, PDF, HTML, MD, CSV, JSON, XML, LaTex 文件, 并将代码块导出为各类脚本文件\(Python, JS, Bash等\)。 | [bowenliang123_md\_exporter_0.5.1.difypkg](/downloads/tool/bowenliang123_md\_exporter_0.5.1.difypkg) |
...
| junjiem/db\_query | 数据库查询 | 数据库查询工具。 | [junjiem_db\_query_0.0.6.difypkg](/downloads/tool/junjiem_db\_query_0.0.6.difypkg) |
...
| ssssshql/chat\_memory\_by\_mongo | MongoDB 会话记忆 | 通过MongoDB存储对话 | [ssssshql_chat\_memory\_by\_mongo_0.0.1.difypkg](/downloads/tool/ssssshql_chat\_memory\_by\_mongo_0.0.1.difypkg) |
...
| langgenius/confluence | Confluence | Confluence 是一个基于 Web 的企业 Wiki，基于Atlassian开发。 | [langgenius_confluence_0.0.1.difypkg](/downloads/tool/langgenius_confluence_0.0.1.difypkg) |
...
| jingfelix/npm\_registry | npm Registry API | 用于访问 npm Registry API 的 Dify 插件 | [jingfelix_npm\_registry_0.0.1.difypkg](/downloads/tool/jingfelix_npm\_registry_0.0.1.difypkg) |
...
| datoujiejie/botos3 | botos3 | 通过s3库上传文件 | [datoujiejie_botos3_0.0.2.difypkg](/downloads/tool/datoujiejie_botos3_0.0.2.difypkg) |
...
| fernvenue/meilisearch | Meilisearch | 与 Meilisearch 实例交互. | [fernvenue_meilisearch_0.1.3.difypkg](/downloads/tool/fernvenue_meilisearch_0.1.3.difypkg) |
...
| junjiem/db\_query\_pre\_auth | 数据库查询（预授权） | 数据库查询工具（预授权）。 | [junjiem_db\_query\_pre\_auth_0.0.6.difypkg](/downloads/tool/junjiem_db\_query\_pre\_auth_0.0.6.difypkg) |
...
| agimaster/crawl4ai | Crawl4AI | 通过API接口访问Crawl4AI的网页内容提取、数据解析和结构化处理等功能，实现高效的网络信息采集，返回markdown或者html格式 | [agimaster_crawl4ai_0.0.2.difypkg](/downloads/tool/agimaster_crawl4ai_0.0.2.difypkg) |
...
| digitforce/data\_analysis | 数据分析 | 基于大模型和自然语言交互的智能数据分析工具，内置数据查询和数据可视化，以及报告生成功能。 | [digitforce_data\_analysis_1.0.6.difypkg](/downloads/tool/digitforce_data\_analysis_1.0.6.difypkg) |
...
| anspire/anspire\_search | 安思派联网搜索 | 面向AI的下一代实时智能搜索引擎，为您的应用提供格式友好的多渠道全网内容。 | [anspire_anspire\_search_0.0.2.difypkg](/downloads/tool/anspire_anspire\_search_0.0.2.difypkg) |
...
| junjiem/mcp\_see\_agent | Agent 策略（支持 MCP 工具） | 提供 Function Calling 和 ReAct 的 Agent 策略集合（支持 MCP SSE / StreamableHTTP 发现和调用工具）。 | [junjiem_mcp\_see\_agent_0.1.4.difypkg](/downloads/agent-strategy/junjiem_mcp\_see\_agent_0.1.4.difypkg) |
...
| kevintsai/linebot | Line Bot | Line Bot | [kevintsai_linebot_0.0.4.difypkg](/downloads/extension/kevintsai_linebot_0.0.4.difypkg) |
