...
| langgenius/tongyi | 通义千问 | 通义千问 | [langgenius_tongyi_0.0.18.difypkg](/downloads/model/langgenius_tongyi_0.0.18.difypkg) |
| langgenius/siliconflow | 硅基流动 | 硅基流动提供对各种模型（LLM、文本嵌入、重排序、STT、TTS）的访问，可通过模型名称、API密钥和其他参数进行配置。 | [langgenius_siliconflow_0.0.9.difypkg](/downloads/model/langgenius_siliconflow_0.0.9.difypkg) |
| langgenius/openai\_api\_compatible | OpenAI-API-compatible | 兼容 OpenAI API 的模型供应商，例如 LM Studio 。 | [langgenius_openai\_api\_compatible_0.0.13.difypkg](/downloads/model/langgenius_openai\_api\_compatible_0.0.13.difypkg) |
| langgenius/gemini | Gemini | 谷歌提供的 Gemini 模型. | [langgenius_gemini_0.1.3.difypkg](/downloads/model/langgenius_gemini_0.1.3.difypkg) |
...
| langgenius/volcengine\_maas | 火山方舟 | 火山方舟提供的模型，例如 Doubao-pro-4k、Doubao-pro-32k 和 Doubao-pro-128k。 | [langgenius_volcengine\_maas_0.0.10.difypkg](/downloads/model/langgenius_volcengine\_maas_0.0.10.difypkg) |
| langgenius/xinference | Xorbits Inference | Xorbits Inference | [langgenius_xinference_0.0.3.difypkg](/downloads/model/langgenius_xinference_0.0.3.difypkg) |
| langgenius/openrouter | OpenRouter | OpenRouter 是一个强大的平台，提供对多种语言模型的访问，包括商业和开源选项。 | [langgenius_openrouter_0.0.7.difypkg](/downloads/model/langgenius_openrouter_0.0.7.difypkg) |
| langgenius/azure\_openai | Azure OpenAI | Azure OpenAI Service Model | [langgenius_azure\_openai_0.0.13.difypkg](/downloads/model/langgenius_azure\_openai_0.0.13.difypkg) |
...
| yangyaofei/vllm | vllm | vllm provider for guided support https\://docs.vllm.ai/en/latest/serving/openai\_compatible\_server.html\#id5 | [yangyaofei_vllm_0.1.4.difypkg](/downloads/model/yangyaofei_vllm_0.1.4.difypkg) |
| langgenius/localai | LocalAI | LocalAI | [langgenius_localai_0.0.3.difypkg](/downloads/model/langgenius_localai_0.0.3.difypkg) |
| langgenius/bedrock | Amazon Bedrock | The models of Amazon Bedrock | [langgenius_bedrock_0.0.10.difypkg](/downloads/model/langgenius_bedrock_0.0.10.difypkg) |
...
| langgenius/x | xAI | xAI is a company working on building artificial intelligence to accelerate human scientific discovery. We are guided by our mission to advance our collective understanding of the universe. | [langgenius_x_0.0.4.difypkg](/downloads/model/langgenius_x_0.0.4.difypkg) |
...
| langgenius/gpustack | GPUStack | GPUStack 是一个专为运行 AI 模型而设计的开源 GPU 集群管理器，致力于支持基于任何品牌的异构 GPU 构建统一管理的算力集群 | [langgenius_gpustack_0.0.6.difypkg](/downloads/model/langgenius_gpustack_0.0.6.difypkg) |
| langgenius/chatglm | ChatGLM | ChatGLM | [langgenius_chatglm_0.0.2.difypkg](/downloads/model/langgenius_chatglm_0.0.2.difypkg) |
| langgenius/vertex\_ai | Vertex AI \| Google Cloud Platform | Vertex AI in Google Cloud Platform. | [langgenius_vertex\_ai_0.0.9.difypkg](/downloads/model/langgenius_vertex\_ai_0.0.9.difypkg) |
...
| langgenius/gitee\_ai | Gitee AI | 快速体验大模型，领先探索 AI 开源世界 | [langgenius_gitee\_ai_0.0.8.difypkg](/downloads/model/langgenius_gitee\_ai_0.0.8.difypkg) |
...
| infiniai/infiniai | 无问芯穹 | 无问芯穹提供大模型推理加速高性能API，涵盖文本、图像、视频等多种模态，支持最新开源DeepSeek等系列LLM模型，以及Jina/bge等sota嵌入重排模型，可通过模型名称、API密钥和其他参数进行配置。 | [infiniai_infiniai_0.0.2.difypkg](/downloads/model/infiniai_infiniai_0.0.2.difypkg) |
...
| higgs-projects/lkeap | 腾讯知识引擎 | 腾讯知识引擎大模型相关原子能力，如deepseek-v3-0324, deepseek-r1. | [higgs-projects_lkeap_0.0.2.difypkg](/downloads/model/higgs-projects_lkeap_0.0.2.difypkg) |
...
| langgenius/perfxcloud | perfxcloud | PerfXCloud | [langgenius_perfxcloud_0.0.5.difypkg](/downloads/model/langgenius_perfxcloud_0.0.5.difypkg) |
...
| hjlarry/database | database | This tool is used to execute SQL in an existing database. | [hjlarry_database_0.0.5.difypkg](/downloads/tool/hjlarry_database_0.0.5.difypkg) |
...
| bowenliang123/md\_exporter | Markdown 转换器 | 导出 Markdown 为 DOCX, PPTX, XLSX, PDF, HTML, MD, CSV, JSON, XML, LaTex 文件, 并将代码块导出为各类脚本文件\(Python, JS, Bash等\)。 | [bowenliang123_md\_exporter_0.4.2.difypkg](/downloads/tool/bowenliang123_md\_exporter_0.4.2.difypkg) |
| langgenius/searxng | SearXNG | 开源免费的互联网元搜索引擎 | [langgenius_searxng_0.0.4.difypkg](/downloads/tool/langgenius_searxng_0.0.4.difypkg) |
| junjiem/mcp\_sse | MCP SSE | 通过 HTTP with SSE 传输使用 MCP 协议来发现和调用工具。 | [junjiem_mcp\_sse_0.0.10.difypkg](/downloads/tool/junjiem_mcp\_sse_0.0.10.difypkg) |
...
| junjiem/db\_query | 数据库查询 | 数据库查询工具。 | [junjiem_db\_query_0.0.5.difypkg](/downloads/tool/junjiem_db\_query_0.0.5.difypkg) |
...
| langgenius/comfyui | ComfyUI | ComfyUI 是一个可以在本地部署的图片生成的工具。 | [langgenius_comfyui_0.0.5.difypkg](/downloads/tool/langgenius_comfyui_0.0.5.difypkg) |
...
| bowenliang123/base64\_codec | Base64 编解码器 | Base64编码及解码，支持文本和图片文件 | [bowenliang123_base64\_codec_0.2.1.difypkg](/downloads/tool/bowenliang123_base64\_codec_0.2.1.difypkg) |
...
| langgenius/email | 电子邮件 | 通过smtp协议发送电子邮件 | [langgenius_email_0.0.6.difypkg](/downloads/tool/langgenius_email_0.0.6.difypkg) |
...
| digitforce/data\_analysis | 数据分析 | 这是一款可以基于大模型进行自然语言数据查询与生成解读报告的工具，提升企业决策效率。 | [digitforce_data\_analysis_1.0.1.difypkg](/downloads/tool/digitforce_data\_analysis_1.0.1.difypkg) |
...
| joto/datafocus | DataFocus | DataFocus，一个问答式交互，搜索式体验的数据分析平台。 | [joto_datafocus_0.0.1.difypkg](/downloads/tool/joto_datafocus_0.0.1.difypkg) |
...
| zm1990s/ai\_security\_api | Palo Alto Networks | PANW AI Runtime Security API | [zm1990s_ai\_security\_api_0.0.3.difypkg](/downloads/tool/zm1990s_ai\_security\_api_0.0.3.difypkg) |
...
| edtechools/mattermost | Mattermost | Mattermost Webhook | [edtechools_mattermost_0.0.1.difypkg](/downloads/tool/edtechools_mattermost_0.0.1.difypkg) |
...
| junjiem/db\_query\_pre\_auth | 数据库查询（预授权） | 数据库查询工具（预授权）。 | [junjiem_db\_query\_pre\_auth_0.0.5.difypkg](/downloads/tool/junjiem_db\_query\_pre\_auth_0.0.5.difypkg) |
...
| quicksandzn/elasticsearch | Elasticsearch | Elasticsearch | [quicksandzn_elasticsearch_0.0.5.difypkg](/downloads/tool/quicksandzn_elasticsearch_0.0.5.difypkg) |
...
| yevanchen/exa | exa | Search designed for AI Business-grade search and crawling for any web data | [yevanchen_exa_0.0.3.difypkg](/downloads/tool/yevanchen_exa_0.0.3.difypkg) |
...
| 插件ID | 名称 | 描述 | 下载 |
| --- | --- | --- | --- |
| langgenius/agent | Dify Agent 策略 | Dify 官方 Agent 策略集合 | [langgenius_agent_0.0.14.difypkg](/downloads/agent-strategy/langgenius_agent_0.0.14.difypkg) |
...
| junjiem/mcp\_see\_agent | Agent 策略（支持 MCP 工具） | 提供 Function Calling 和 ReAct 的 Agent 策略集合（支持 MCP SSE 发现和调用工具）。 | [junjiem_mcp\_see\_agent_0.0.11.difypkg](/downloads/agent-strategy/junjiem_mcp\_see\_agent_0.0.11.difypkg) |
...
| junjiem/mcp\_compat\_dify\_tools | MCP Compatible Dify Tools | 将您的Dify工具的API转换为MCP兼容API | [junjiem_mcp\_compat\_dify\_tools_0.0.2.difypkg](/downloads/extension/junjiem_mcp\_compat\_dify\_tools_0.0.2.difypkg) |
