...
| langgenius/openai | OpenAI | OpenAI 提供的模型，例如 GPT-3.5-Turbo 和 GPT-4。 | [langgenius_openai_0.0.11.difypkg](/downloads/model/langgenius_openai_0.0.11.difypkg) |
...
| langgenius/tongyi | 通义千问 | 通义千问 | [langgenius_tongyi_0.0.6.difypkg](/downloads/model/langgenius_tongyi_0.0.6.difypkg) |
...
| langgenius/azure\_openai | Azure OpenAI | Azure OpenAI Service Model | [langgenius_azure\_openai_0.0.4.difypkg](/downloads/model/langgenius_azure\_openai_0.0.4.difypkg) |
| langgenius/zhipuai | Zhipuai | 智谱 AI | [langgenius_zhipuai_0.0.6.difypkg](/downloads/model/langgenius_zhipuai_0.0.6.difypkg) |
| langgenius/jina | Jina | Embedding and Rerank Model Supported | [langgenius_jina_0.0.4.difypkg](/downloads/model/langgenius_jina_0.0.4.difypkg) |
...
| langgenius/cohere | Cohere | Cohere | [langgenius_cohere_0.0.5.difypkg](/downloads/model/langgenius_cohere_0.0.5.difypkg) |
| langgenius/bedrock | AWS | AWS Bedrock's models. | [langgenius_bedrock_0.0.5.difypkg](/downloads/model/langgenius_bedrock_0.0.5.difypkg) |
...
| langgenius/groq | GroqCloud | GroqCloud 提供对 Groq Cloud API 的访问，其中托管了 LLama2 和 Mixtral 等模型。 | [langgenius_groq_0.0.4.difypkg](/downloads/model/langgenius_groq_0.0.4.difypkg) |
...
| langgenius/vertex\_ai | Vertex AI \| Google Cloud Platform | Vertex AI in Google Cloud Platform. | [langgenius_vertex\_ai_0.0.6.difypkg](/downloads/model/langgenius_vertex\_ai_0.0.6.difypkg) |
...
| langgenius/gitee\_ai | Gitee AI | 快速体验大模型，领先探索 AI 开源世界 | [langgenius_gitee\_ai_0.0.5.difypkg](/downloads/model/langgenius_gitee\_ai_0.0.5.difypkg) |
...
| aws/amazon-bedrock | Amazon Bedrock | The models of Amazon Bedrock | [aws_amazon-bedrock_0.0.5.difypkg](/downloads/model/aws_amazon-bedrock_0.0.5.difypkg) |
...
| 插件ID | 名称 | 描述 | 下载 |
| --- | --- | --- | --- |
| langgenius/tavily | Tavily 搜索和提取 | 一个强大的原生AI搜索引擎和网页内容提取工具，提供高度相关的搜索结果和网页原始内容提取。 | [langgenius_tavily_0.0.2.difypkg](/downloads/tool/langgenius_tavily_0.0.2.difypkg) |
...
| langgenius/jina\_tool | Jina AI | 您的搜索底座，从此不同! | [langgenius_jina\_tool_0.0.3.difypkg](/downloads/tool/langgenius_jina\_tool_0.0.3.difypkg) |
...
| langgenius/email | 电子邮件 | 通过smtp协议发送电子邮件 | [langgenius_email_0.0.2.difypkg](/downloads/tool/langgenius_email_0.0.2.difypkg) |
...
| langgenius/slidespeak | SlideSpeak | 使用 SlideSpeak API 生成演示幻灯片 | [langgenius_slidespeak_0.0.3.difypkg](/downloads/tool/langgenius_slidespeak_0.0.3.difypkg) |
...
| bowenliang123/md\_exporter | Markdown 转换器 | 导出 Markdown 为 Docx、Xlsx、PDF、HTML、md 文件。 | [bowenliang123_md\_exporter_0.0.2.difypkg](/downloads/tool/bowenliang123_md\_exporter_0.0.2.difypkg) |
...
| r3-yamauchi/kintone\_integration | kintone\_integration | kintone Plugin | [r3-yamauchi_kintone\_integration_0.0.3.difypkg](/downloads/tool/r3-yamauchi_kintone\_integration_0.0.3.difypkg) |
...
| plutoless/convoai | Agora Conversational AI | Agora Conversational AI 是一个会话式 AI 平台，使开发人员能够构建由 Dify Agent 提供支持的语音助手。 | [plutoless_convoai_0.0.1.difypkg](/downloads/extension/plutoless_convoai_0.0.1.difypkg) |
