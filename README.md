...
| langgenius/gemini | Gemini | 谷歌提供的 Gemini 模型. | [langgenius_gemini_0.1.4.difypkg](/downloads/model/langgenius_gemini_0.1.4.difypkg) |
| langgenius/volcengine\_maas | 火山方舟 | 火山方舟提供的模型，例如 Doubao-pro-4k、Doubao-pro-32k 和 Doubao-pro-128k。 | [langgenius_volcengine\_maas_0.0.11.difypkg](/downloads/model/langgenius_volcengine\_maas_0.0.11.difypkg) |
...
| langgenius/azure\_openai | Azure OpenAI | Azure OpenAI Service Model | [langgenius_azure\_openai_0.0.14.difypkg](/downloads/model/langgenius_azure\_openai_0.0.14.difypkg) |
...
| langgenius/zhipuai | Zhipuai | 智谱 AI | [langgenius_zhipuai_0.0.8.difypkg](/downloads/model/langgenius_zhipuai_0.0.8.difypkg) |
...
| langgenius/minimax | Minimax | Minimax | [langgenius_minimax_0.0.5.difypkg](/downloads/model/langgenius_minimax_0.0.5.difypkg) |
...
| junjiem/mcp\_sse | MCP SSE / StreamableHTTP | 通过 HTTP with SSE 或 Streamable HTTP 传输方式使用 MCP 协议来发现和调用工具。 | [junjiem_mcp\_sse_0.1.0.difypkg](/downloads/tool/junjiem_mcp\_sse_0.1.0.difypkg) |
| langgenius/wecom | 企业微信 | 企业微信群机器人 | [langgenius_wecom_0.0.2.difypkg](/downloads/tool/langgenius_wecom_0.0.2.difypkg) |
| bowenliang123/md\_exporter | Markdown 转换器 | 导出 Markdown 为 DOCX, PPTX, XLSX, PDF, HTML, MD, CSV, JSON, XML, LaTex 文件, 并将代码块导出为各类脚本文件\(Python, JS, Bash等\)。 | [bowenliang123_md\_exporter_0.5.0.difypkg](/downloads/tool/bowenliang123_md\_exporter_0.5.0.difypkg) |
...
| langgenius/comfyui | ComfyUI | ComfyUI 是一个可以在本地部署的图片生成的工具。 | [langgenius_comfyui_0.0.6.difypkg](/downloads/tool/langgenius_comfyui_0.0.6.difypkg) |
...
| langgenius/mineru | MinerU | MinerU是一款可以在本地部署的将PDF转化为机器可读格式的工具（如markdown、json），可以很方便地抽取为任意格式。MinerU诞生于书生-浦语的预训练过程中，我们将会集中精力解决科技文献中的符号转化问题，希望在大模型时代为科技发展做出贡献。https\://github.com/opendatalab/MinerU | [langgenius_mineru_0.1.0.difypkg](/downloads/tool/langgenius_mineru_0.1.0.difypkg) |
...
| caffbyte/imagetool | 图像工具 | Dify平台的插件，提供图像处理功能，包括文本到图像的生成。 | [caffbyte_imagetool_0.0.1.difypkg](/downloads/tool/caffbyte_imagetool_0.0.1.difypkg) |
...
| digitforce/data\_analysis | 数据分析 | 这是一款可以基于大模型进行自然语言数据分析与生成解读报告的工具，提升企业决策效率。 | [digitforce_data\_analysis_1.0.3.difypkg](/downloads/tool/digitforce_data\_analysis_1.0.3.difypkg) |
...
| joto/datafocus | DataFocus | 包含了一个幻觉可控的Text2SQL极速生成插件；以及一个可多轮问数的ChatBI插件。 | [joto_datafocus_0.0.2.difypkg](/downloads/tool/joto_datafocus_0.0.2.difypkg) |
...
| liuxin/image-compression | 图片压缩 | 图片压缩工具 | [liuxin_image-compression_0.0.1.difypkg](/downloads/tool/liuxin_image-compression_0.0.1.difypkg) |
...
| axdlee/safety\_chat | 安全聊天 | 一个用于实现访问频率限制、外部用户认证的插件 | [axdlee_safety\_chat_0.0.1.difypkg](/downloads/tool/axdlee_safety\_chat_0.0.1.difypkg) |
...
| jaguarliuu/rookie\_data\_alchemy | rookie\_data\_alchemy | Visualizing structured data as charts | [jaguarliuu_rookie\_data\_alchemy_0.0.3.difypkg](/downloads/tool/jaguarliuu_rookie\_data\_alchemy_0.0.3.difypkg) |
...
| alterxyz/gpg\_text | GPG 文本工具 | 一套用于 GPG 操作的工具集：使用 pgpy 进行消息加密、解密、签名、验证以及生成密钥对。 | [alterxyz_gpg\_text_0.0.1.difypkg](/downloads/tool/alterxyz_gpg\_text_0.0.1.difypkg) |
...
| majinkai/database\_to\_knowledge | 表结构写入知识库 | 此工具将数据库表结构写入知识库 | [majinkai_database\_to\_knowledge_0.0.3.difypkg](/downloads/tool/majinkai_database\_to\_knowledge_0.0.3.difypkg) |
...
| yevanchen/exa | exa | Search designed for AI Business-grade search and crawling for any web data | [yevanchen_exa_0.0.4.difypkg](/downloads/tool/yevanchen_exa_0.0.4.difypkg) |
...
| junjiem/mcp\_see\_agent | Agent 策略（支持 MCP 工具） | 提供 Function Calling 和 ReAct 的 Agent 策略集合（支持 MCP SSE / StreamableHTTP 发现和调用工具）。 | [junjiem_mcp\_see\_agent_0.1.0.difypkg](/downloads/agent-strategy/junjiem_mcp\_see\_agent_0.1.0.difypkg) |
...
| junjiem/mcp\_compat\_dify\_tools | MCP Compatible Dify Tools | 将您的Dify工具的API转换为MCP兼容API（注：必须 dify 1.2.0+） | [junjiem_mcp\_compat\_dify\_tools_0.1.0.difypkg](/downloads/extension/junjiem_mcp\_compat\_dify\_tools_0.1.0.difypkg) |
