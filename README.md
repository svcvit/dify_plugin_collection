...
| langgenius/openai | OpenAI | OpenAI 提供的模型，例如 GPT-3.5-Turbo 和 GPT-4。 | [langgenius_openai_0.0.12.difypkg](/downloads/model/langgenius_openai_0.0.12.difypkg) |
...
| langgenius/siliconflow | 硅基流动 | 硅基流动提供对各种模型（LLM、文本嵌入、重排序、STT、TTS）的访问，可通过模型名称、API密钥和其他参数进行配置。 | [langgenius_siliconflow_0.0.7.difypkg](/downloads/model/langgenius_siliconflow_0.0.7.difypkg) |
| langgenius/tongyi | 通义千问 | 通义千问 | [langgenius_tongyi_0.0.11.difypkg](/downloads/model/langgenius_tongyi_0.0.11.difypkg) |
| langgenius/openai\_api\_compatible | OpenAI-API-compatible | 兼容 OpenAI API 的模型供应商，例如 LM Studio 。 | [langgenius_openai\_api\_compatible_0.0.7.difypkg](/downloads/model/langgenius_openai\_api\_compatible_0.0.7.difypkg) |
...
| langgenius/anthropic | Anthropic | Anthropic 的强大模型。 | [langgenius_anthropic_0.0.9.difypkg](/downloads/model/langgenius_anthropic_0.0.9.difypkg) |
...
| langgenius/azure\_openai | Azure OpenAI | Azure OpenAI Service Model | [langgenius_azure\_openai_0.0.8.difypkg](/downloads/model/langgenius_azure\_openai_0.0.8.difypkg) |
| langgenius/zhipuai | Zhipuai | 智谱 AI | [langgenius_zhipuai_0.0.6.difypkg](/downloads/model/langgenius_zhipuai_0.0.6.difypkg) |
...
| langgenius/moonshot | 月之暗面 | Moonshot 提供的模型，例如 moonshot-v1-8k、moonshot-v1-32k 和 moonshot-v1-128k。 | [langgenius_moonshot_0.0.3.difypkg](/downloads/model/langgenius_moonshot_0.0.3.difypkg) |
| langgenius/openrouter | OpenRouter | OpenRouter 是一个强大的平台，提供对多种语言模型的访问，包括商业和开源选项。 | [langgenius_openrouter_0.0.4.difypkg](/downloads/model/langgenius_openrouter_0.0.4.difypkg) |
| langgenius/hunyuan | 腾讯混元 | 腾讯混元提供的模型，例如 hunyuan-standard、 hunyuan-standard-256k, hunyuan-pro, hunyuan-role, hunyuan-large, hunyuan-large-role, hunyuan-turbo-latest, hunyuan-large-longcontext, hunyuan-turbo, hunyuan-vision, hunyuan-turbo-vision, hunyuan-functioncall 和 hunyuan-lite。 | [langgenius_hunyuan_0.0.4.difypkg](/downloads/model/langgenius_hunyuan_0.0.4.difypkg) |
...
| langgenius/cohere | Cohere | Cohere | [langgenius_cohere_0.0.6.difypkg](/downloads/model/langgenius_cohere_0.0.6.difypkg) |
| langgenius/localai | LocalAI | LocalAI | [langgenius_localai_0.0.3.difypkg](/downloads/model/langgenius_localai_0.0.3.difypkg) |
| langgenius/bedrock | Amazon Bedrock | The models of Amazon Bedrock | [langgenius_bedrock_0.0.8.difypkg](/downloads/model/langgenius_bedrock_0.0.8.difypkg) |
...
| langgenius/groq | GroqCloud | GroqCloud 提供对 Groq Cloud API 的访问，其中托管了 LLama2 和 Mixtral 等模型。 | [langgenius_groq_0.0.5.difypkg](/downloads/model/langgenius_groq_0.0.5.difypkg) |
...
| langgenius/gpustack | GPUStack | GPUStack 是一个专为运行 AI 模型而设计的开源 GPU 集群管理器，致力于支持基于任何品牌的异构 GPU 构建统一管理的算力集群 | [langgenius_gpustack_0.0.3.difypkg](/downloads/model/langgenius_gpustack_0.0.3.difypkg) |
| langgenius/vertex\_ai | Vertex AI \| Google Cloud Platform | Vertex AI in Google Cloud Platform. | [langgenius_vertex\_ai_0.0.7.difypkg](/downloads/model/langgenius_vertex\_ai_0.0.7.difypkg) |
...
| langgenius/gitee\_ai | Gitee AI | 快速体验大模型，领先探索 AI 开源世界 | [langgenius_gitee\_ai_0.0.6.difypkg](/downloads/model/langgenius_gitee\_ai_0.0.6.difypkg) |
...
| langgenius/voyage | Voyage | Voyage | [langgenius_voyage_0.0.3.difypkg](/downloads/model/langgenius_voyage_0.0.3.difypkg) |
...
| langgenius/sagemaker | Sagemaker | Sagemaker上的私有化部署的模型 | [langgenius_sagemaker_0.0.3.difypkg](/downloads/model/langgenius_sagemaker_0.0.3.difypkg) |
| langgenius/novita | Novita | Novita | [langgenius_novita_0.0.2.difypkg](/downloads/model/langgenius_novita_0.0.2.difypkg) |
...
| 插件ID | 名称 | 描述 | 下载 |
| --- | --- | --- | --- |
| langgenius/tavily | Tavily | 一个强大的原生AI搜索引擎和网页内容提取工具，提供高度相关的搜索结果和网页原始内容提取。 | [langgenius_tavily_0.0.4.difypkg](/downloads/tool/langgenius_tavily_0.0.4.difypkg) |
...
| hjlarry/database | database | This tool is used to execute SQL in an existing database. | [hjlarry_database_0.0.2.difypkg](/downloads/tool/hjlarry_database_0.0.2.difypkg) |
...
| langgenius/github | Github | GitHub是一个在线软件源代码托管服务平台。 | [langgenius_github_0.0.2.difypkg](/downloads/tool/langgenius_github_0.0.2.difypkg) |
| bowenliang123/md\_exporter | Markdown 转换器 | 导出 Markdown 为 Docx, PDF, HTML, md, Xlsx, CSV, JSON, XML 文件。 | [bowenliang123_md\_exporter_0.0.3.difypkg](/downloads/tool/bowenliang123_md\_exporter_0.0.3.difypkg) |
...
| langgenius/email | 电子邮件 | 通过smtp协议发送电子邮件 | [langgenius_email_0.0.3.difypkg](/downloads/tool/langgenius_email_0.0.3.difypkg) |
...
| langgenius/wolframalpha | WolframAlpha | WolframAlpha 是一个强大的计算知识引擎。 | [langgenius_wolframalpha_0.0.2.difypkg](/downloads/tool/langgenius_wolframalpha_0.0.2.difypkg) |
...
| yevanchen/markitdown | markitdown | Python tool for converting files and office documents to Markdown. | [yevanchen_markitdown_0.0.1.difypkg](/downloads/tool/yevanchen_markitdown_0.0.1.difypkg) |
...
| langgenius/aws\_tools | AWS | AWS Tools | [langgenius_aws\_tools_0.0.2.difypkg](/downloads/tool/langgenius_aws\_tools_0.0.2.difypkg) |
...
| itning/bark-notify | Bark通知 | 用于推送消息到Bark应用程序中。 | [itning_bark-notify_0.0.1.difypkg](/downloads/tool/itning_bark-notify_0.0.1.difypkg) |
...
| aws/aws\_tools | AWS | AWS Tools | [aws_aws\_tools_0.0.2.difypkg](/downloads/tool/aws_aws\_tools_0.0.2.difypkg) |
...
| langgenius/oaicompat\_dify\_model | OpenAI Compatible Dify Models | 将您的Dify模型转换为OpenAI兼容API | [langgenius_oaicompat\_dify\_model_0.0.4.difypkg](/downloads/extension/langgenius_oaicompat\_dify\_model_0.0.4.difypkg) |
| plutoless/convoai | Agora Conversational AI | Agora Conversational AI 是一个会话式 AI 平台，使开发人员能够构建由 Dify Agent 提供支持的语音助手。 | [plutoless_convoai_0.0.2.difypkg](/downloads/extension/plutoless_convoai_0.0.2.difypkg) |
