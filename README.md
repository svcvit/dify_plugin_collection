...
| langgenius/openai | OpenAI | OpenAI 提供的模型，例如 GPT-3.5-Turbo 和 GPT-4。 | [langgenius_openai_0.0.15.difypkg](/downloads/model/langgenius_openai_0.0.15.difypkg) |
...
| langgenius/gemini | Gemini | 谷歌提供的 Gemini 模型. | [langgenius_gemini_0.1.1.difypkg](/downloads/model/langgenius_gemini_0.1.1.difypkg) |
| langgenius/anthropic | Anthropic | Anthropic 的强大模型。 | [langgenius_anthropic_0.0.13.difypkg](/downloads/model/langgenius_anthropic_0.0.13.difypkg) |
...
| langgenius/azure\_openai | Azure OpenAI | Azure OpenAI Service Model | [langgenius_azure\_openai_0.0.12.difypkg](/downloads/model/langgenius_azure\_openai_0.0.12.difypkg) |
| langgenius/openrouter | OpenRouter | OpenRouter 是一个强大的平台，提供对多种语言模型的访问，包括商业和开源选项。 | [langgenius_openrouter_0.0.6.difypkg](/downloads/model/langgenius_openrouter_0.0.6.difypkg) |
...
| yangyaofei/vllm | vllm | vllm provider for guided support https\://docs.vllm.ai/en/latest/serving/openai\_compatible\_server.html\#id5 | [yangyaofei_vllm_0.1.3.difypkg](/downloads/model/yangyaofei_vllm_0.1.3.difypkg) |
...
| bowenliang123/md\_exporter | Markdown 转换器 | 导出 Markdown 为 DOCX, PPTX, XLSX, PDF, HTML, MD, CSV, JSON, XML, LaTex 文件, 并将代码块导出为各类脚本文件\(Python, JS, Bash等\)。 | [bowenliang123_md\_exporter_0.4.0.difypkg](/downloads/tool/bowenliang123_md\_exporter_0.4.0.difypkg) |
...
| junjiem/db\_query | 数据库查询 | 数据库查询工具。 | [junjiem_db\_query_0.0.4.difypkg](/downloads/tool/junjiem_db\_query_0.0.4.difypkg) |
...
| jaguarliuu/rookie\_text2data | rookie\_text2data | 自然语言查询 MySQL 数据. | [jaguarliuu_rookie\_text2data_0.2.1.difypkg](/downloads/tool/jaguarliuu_rookie\_text2data_0.2.1.difypkg) |
| langgenius/perplexity | Perplexity | Perplexity.AI | [langgenius_perplexity_0.0.4.difypkg](/downloads/tool/langgenius_perplexity_0.0.4.difypkg) |
...
| junjiem/mcp\_sse | MCP SSE | 通过 HTTP with SSE 传输使用 MCP 协议来发现和调用工具。 | [junjiem_mcp\_sse_0.0.6.difypkg](/downloads/tool/junjiem_mcp\_sse_0.0.6.difypkg) |
...
| bowenliang123/base64\_codec | Base64 编解码器 | Base64编码及解码，支持文本和图片文件 | [bowenliang123_base64\_codec_0.1.0.difypkg](/downloads/tool/bowenliang123_base64\_codec_0.1.0.difypkg) |
...
| agimaster/crawl4ai | Crawl4AI | 通过API接口访问Crawl4AI的网页内容提取、数据解析和结构化处理等功能，实现高效的网络信息采集，返回markdown或者html格式 | [agimaster_crawl4ai_0.0.1.difypkg](/downloads/tool/agimaster_crawl4ai_0.0.1.difypkg) |
...
| omluc/google\_sheets | google\_sheets | integration for google sheets | [omluc_google\_sheets_0.0.1.difypkg](/downloads/tool/omluc_google\_sheets_0.0.1.difypkg) |
...
| qin2dim/table\_cooking | table\_cooking | Cooking on tabular data, smooth Q&A | [qin2dim_table\_cooking_0.0.2.difypkg](/downloads/tool/qin2dim_table\_cooking_0.0.2.difypkg) |
...
| alterxyz/totp | TOTP | 动态口令 TOTP（Time based One Time Password\) | [alterxyz_totp_0.0.2.difypkg](/downloads/tool/alterxyz_totp_0.0.2.difypkg) |
...
| junjiem/db\_query\_pre\_auth | 数据库查询（预授权） | 数据库查询工具（预授权）。 | [junjiem_db\_query\_pre\_auth_0.0.4.difypkg](/downloads/tool/junjiem_db\_query\_pre\_auth_0.0.4.difypkg) |
...
| quicksandzn/elasticsearch | Elasticsearch | Elasticsearch | [quicksandzn_elasticsearch_0.0.4.difypkg](/downloads/tool/quicksandzn_elasticsearch_0.0.4.difypkg) |
| bowenliang123/random | 随机生成器 | 生成随机数、字符串、UUID、质数等。 | [bowenliang123_random_0.1.0.difypkg](/downloads/tool/bowenliang123_random_0.1.0.difypkg) |
...
| majinkai/database\_to\_knowledge | 表结构写入知识库 | 此工具将数据库表结构写入知识库 | [majinkai_database\_to\_knowledge_0.0.2.difypkg](/downloads/tool/majinkai_database\_to\_knowledge_0.0.2.difypkg) |
| dupdub-dify/dupdub | DupDub | DupDub | [dupdub-dify_dupdub_0.0.3.difypkg](/downloads/tool/dupdub-dify_dupdub_0.0.3.difypkg) |
| alterxyz/data\_function\_conversation\_memory | 会话记忆 | 存储和访问会话 | [alterxyz_data\_function\_conversation\_memory_0.0.3.difypkg](/downloads/tool/alterxyz_data\_function\_conversation\_memory_0.0.3.difypkg) |
...
| 插件ID | 名称 | 描述 | 下载 |
| --- | --- | --- | --- |
| langgenius/agent | Dify Agent 策略 | Dify 官方 Agent 策略集合 | [langgenius_agent_0.0.12.difypkg](/downloads/agent-strategy/langgenius_agent_0.0.12.difypkg) |
| svcvit/agent | 对话 Agent | 针对对话场景优化的Agent策略，例如：多轮对话、上下文理解、信息收集等 | [svcvit_agent_0.0.3.difypkg](/downloads/agent-strategy/svcvit_agent_0.0.3.difypkg) |
...
| junjiem/mcp\_see\_agent | Agent 策略（支持 MCP 工具） | 提供 Function Calling 和 ReAct 的 Agent 策略集合（支持 MCP SSE 发现和调用工具）。 | [junjiem_mcp\_see\_agent_0.0.6.difypkg](/downloads/agent-strategy/junjiem_mcp\_see\_agent_0.0.6.difypkg) |
...
| bikeread/dify\_wechat\_plugin | 微信公众号对接助手 | 连接dify与微信公众号 | [bikeread_dify\_wechat\_plugin_0.0.2.difypkg](/downloads/extension/bikeread_dify\_wechat\_plugin_0.0.2.difypkg) |
