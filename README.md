...
| langgenius/gemini | Gemini | 谷歌提供的 Gemini 模型. | [langgenius_gemini_0.1.5.difypkg](/downloads/model/langgenius_gemini_0.1.5.difypkg) |
...
| langgenius/huggingface\_hub | Hugging Face Hub | Hugging Face Model | [langgenius_huggingface\_hub_0.0.4.difypkg](/downloads/model/langgenius_huggingface\_hub_0.0.4.difypkg) |
...
| langgenius/bedrock | Amazon Bedrock | The models of Amazon Bedrock | [langgenius_bedrock_0.0.12.difypkg](/downloads/model/langgenius_bedrock_0.0.12.difypkg) |
...
| majinkai/database\_to\_knowledge | 表结构写入知识库 | 此工具将数据库表结构写入知识库 | [majinkai_database\_to\_knowledge_0.0.4.difypkg](/downloads/tool/majinkai_database\_to\_knowledge_0.0.4.difypkg) |
...
| digitforce/data\_analysis | 数据分析 | 这是一款可以基于大模型进行自然语言数据分析、生成解读报告、进行可视化的工具，提升企业决策效率。 | [digitforce_data\_analysis_1.0.4.difypkg](/downloads/tool/digitforce_data\_analysis_1.0.4.difypkg) |
| jaguarliuu/rookie\_data\_alchemy | rookie\_data\_alchemy | Visualizing structured data as charts | [jaguarliuu_rookie\_data\_alchemy_0.0.3-snapshot.difypkg](/downloads/tool/jaguarliuu_rookie\_data\_alchemy_0.0.3-snapshot.difypkg) |
