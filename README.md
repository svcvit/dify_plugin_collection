...
| langgenius/tongyi | 通义千问 | 通义千问 | [langgenius_tongyi_0.0.13.difypkg](/downloads/model/langgenius_tongyi_0.0.13.difypkg) |
...
| langgenius/volcengine\_maas | 火山方舟 | 火山方舟提供的模型，例如 Doubao-pro-4k、Doubao-pro-32k 和 Doubao-pro-128k。 | [langgenius_volcengine\_maas_0.0.7.difypkg](/downloads/model/langgenius_volcengine\_maas_0.0.7.difypkg) |
...
| hjlarry/database | database | This tool is used to execute SQL in an existing database. | [hjlarry_database_0.0.3.difypkg](/downloads/tool/hjlarry_database_0.0.3.difypkg) |
...
| bowenliang123/md\_exporter | Markdown 转换器 | 导出 Markdown 为 DOCX, PPTX, XLSX, PDF, HTML, MD, CSV, JSON, XML, LaTex 文件, 并将代码块导出为各类脚本文件\(Python, JS, Bash等\)。 | [bowenliang123_md\_exporter_0.2.0.difypkg](/downloads/tool/bowenliang123_md\_exporter_0.2.0.difypkg) |
| langgenius/dingtalk | 钉钉 | 钉钉群机器人 | [langgenius_dingtalk_0.0.2.difypkg](/downloads/tool/langgenius_dingtalk_0.0.2.difypkg) |
...
| junjiem/mcp\_sse | MCP SSE | 通过 HTTP with SSE 传输使用 MCP 协议来发现和调用工具。 | [junjiem_mcp\_sse_0.0.3.difypkg](/downloads/tool/junjiem_mcp\_sse_0.0.3.difypkg) |
...
| langgenius/email | 电子邮件 | 通过smtp协议发送电子邮件 | [langgenius_email_0.0.4.difypkg](/downloads/tool/langgenius_email_0.0.4.difypkg) |
...
| yevanchen/pymupdf | pymupdf | PyMuPDF is a high performance Python library for data extraction, analysis, conversion & manipulation of PDF \(and other\) documents | [yevanchen_pymupdf_0.0.1.difypkg](/downloads/tool/yevanchen_pymupdf_0.0.1.difypkg) |
...
| itning/bark-notify | Bark通知 | 用于推送消息到Bark应用程序中。 | [itning_bark-notify_0.0.2.difypkg](/downloads/tool/itning_bark-notify_0.0.2.difypkg) |
...
| 插件ID | 名称 | 描述 | 下载 |
| --- | --- | --- | --- |
| langgenius/agent | Dify Agent 策略 | Dify 官方 Agent 策略集合 | [langgenius_agent_0.0.9.difypkg](/downloads/agent-strategy/langgenius_agent_0.0.9.difypkg) |
...
| junjiem/mcp\_see\_agent | Dify Agent 策略（支持 MCP 工具） | Dify 官方 Agent 策略集合（支持 MCP SSE 发现和调用工具）。 | [junjiem_mcp\_see\_agent_0.0.3.difypkg](/downloads/agent-strategy/junjiem_mcp\_see\_agent_0.0.3.difypkg) |
...
| plutoless/convoai | Agora Conversational AI | Agora Conversational AI 是一个会话式 AI 平台，使开发人员能够构建由 Dify Agent 提供支持的语音助手。 | [plutoless_convoai_0.0.5.difypkg](/downloads/extension/plutoless_convoai_0.0.5.difypkg) |
